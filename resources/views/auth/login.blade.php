                    ...
                    <div class="col-12">
                        ...
                        <form class="form-horizontal m-t-20" id="loginform" action="{{route('login')}}" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" required name="email" placeholder="email" aria-label="email" aria-describedby="basic-addon1">
                                @error('email')
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control form-control-lg" required placeholder="Password" name="password" aria-label="Password" aria-describedby="basic-addon1">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
